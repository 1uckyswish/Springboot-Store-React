    ...
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="text-center lg:text-left">
          {!user && <h1 className="text-5xl font-bold">Register Now!</h1>}
          {user ? (
            <p className="py-6">You have already registered and are logged in. Please log out to register a new account.</p>
          ) : (
